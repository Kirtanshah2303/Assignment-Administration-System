...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './course-assignment-output.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEASSIGNMENTOUTPUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEASSIGNMENTOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEASSIGNMENTOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEASSIGNMENTOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEASSIGNMENTOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEASSIGNMENTOUTPUT actions', async () => {
      const expectedActions = [
        {
