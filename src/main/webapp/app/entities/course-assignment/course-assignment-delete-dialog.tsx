...
export const CourseAssignmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="assignmentAdministrationSystemApp.courseAssignment.delete.question">
        <Translate
          contentKey="assignmentAdministrationSystemApp.courseAssignment.delete.question"
          interpolate={{ id: courseAssignmentEntity.id }}
        >
