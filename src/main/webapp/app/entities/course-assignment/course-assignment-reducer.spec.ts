...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './course-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEASSIGNMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
