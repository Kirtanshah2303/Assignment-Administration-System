...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './course-assignment-input.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEASSIGNMENTINPUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEASSIGNMENTINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEASSIGNMENTINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEASSIGNMENTINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEASSIGNMENTINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEASSIGNMENTINPUT actions', async () => {
      const expectedActions = [
        {
