...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSESESSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSESESSION actions', async () => {
      const expectedActions = [
        {
