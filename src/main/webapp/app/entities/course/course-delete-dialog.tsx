...
export const CourseDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="assignmentAdministrationSystemApp.course.delete.question">
        <Translate contentKey="assignmentAdministrationSystemApp.course.delete.question" interpolate={{ id: courseEntity.id }}>
