...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSECATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSECATEGORY actions', async () => {
      const expectedActions = [
        {
