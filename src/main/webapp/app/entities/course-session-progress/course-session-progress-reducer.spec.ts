...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './course-session-progress.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSESESSIONPROGRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSESESSIONPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSESESSIONPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSESESSIONPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSESESSIONPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSESESSIONPROGRESS actions', async () => {
      const expectedActions = [
        {
