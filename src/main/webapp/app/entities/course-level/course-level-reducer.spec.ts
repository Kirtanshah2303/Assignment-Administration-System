...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSELEVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSELEVEL actions', async () => {
      const expectedActions = [
        {
