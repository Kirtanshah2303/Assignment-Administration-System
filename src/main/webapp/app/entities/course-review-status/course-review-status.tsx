  ...
  return (
    <div>
      <h2 id="course-review-status-heading" data-cy="CourseReviewStatusHeading">
        <Translate contentKey="assignmentAdministrationSystemApp.courseReviewStatus.home.title">Course Review Statuses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="assignmentAdministrationSystemApp.courseReviewStatus.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="assignmentAdministrationSystemApp.courseReviewStatus.home.createLabel">
              Create new Course Review Status
            </Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseReviewStatusList && courseReviewStatusList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="assignmentAdministrationSystemApp.courseReviewStatus.home.notFound">
                No Course Review Statuses found
              </Translate>
            </div>
          )
        )}
