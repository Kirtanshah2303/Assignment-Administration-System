...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './course-review-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEREVIEWSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEREVIEWSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEREVIEWSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEREVIEWSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEREVIEWSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEREVIEWSTATUS actions', async () => {
      const expectedActions = [
        {
