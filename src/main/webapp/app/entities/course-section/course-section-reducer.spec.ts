...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSESECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSESECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSESECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSESECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSESECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSESECTION actions', async () => {
      const expectedActions = [
        {
