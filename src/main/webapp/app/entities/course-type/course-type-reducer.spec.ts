...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSETYPE actions', async () => {
      const expectedActions = [
        {
