...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './course-assignment-progress.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEASSIGNMENTPROGRESS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEASSIGNMENTPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEASSIGNMENTPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEASSIGNMENTPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEASSIGNMENTPROGRESS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEASSIGNMENTPROGRESS actions', async () => {
      const expectedActions = [
        {
